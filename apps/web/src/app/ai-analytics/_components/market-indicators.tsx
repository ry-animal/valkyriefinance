    ...
    return (
        <Card>
            ...
            <CardContent className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <IndicatorCard title="Fear & Greed" value={data.fearGreedIndex.toString()} description={data.interpretation.fearGreed} />
                <IndicatorCard title="Total Market Cap" value={`$${(data.totalMarketCap / 1e12).toFixed(2)}T`} />
...
function IndicatorCard({ title, value, description }: { title: string; value: string; description?: string }) {
    return (
