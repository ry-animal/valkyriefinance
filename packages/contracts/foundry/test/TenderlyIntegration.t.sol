...
contract TenderlyIntegrationTest is Test {
    ...
    function test_TenderlyAIMonitoring() public {
        ...
        assertTrue(totalSupply == 1000, "Initial total supply should be 1000 (dead shares)");
        assertTrue(vault.effectiveTotalSupply() == 0, "Initial effective supply should be 0");
    }
