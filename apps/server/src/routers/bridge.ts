...
import { bridgeQuoteSchema, bridgeSwapSchema } from '@valkryie/common/schemas'
...
export const bridgeRouter = router({
  ...
  getSwap: publicProcedure.input(bridgeSwapSchema).query(async ({ input }) => {
    try {
      ...
      const bestTrade = await quoteResponse.json()
