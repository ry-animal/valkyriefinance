...
contract SecurityTest is Test {
    ...
    function test_TokenStakeInsufficientBalance() public {
        ...
        // With dead shares protection, first deposit maintains 1:1 ratio for effective supply
        assertEq(shares, smallDeposit); // 1:1 ratio due to our fixed conversion logic
        assertEq(vault.balanceOf(user), shares);
        assertEq(vault.effectiveTotalSupply(), shares); // Effective supply should match user shares
    }
    ...
    function test_VaultWithZeroTotalAssets() public view {
        ...
        // Vault has dead shares for inflation attack protection
