...
export const CONTRACT_ADDRESSES = {
  // Ethereum Mainnet (1)
  1: {
    valkyrieToken: '0x742d35Cc674C4532A93a5C18d6f8C0C2a16055a8' as `0x${string}`,
  ...
  // Arbitrum (42161)
  42161: {
    valkyrieToken: '0x93a5C18d6f8C0C2a16055a8742d35Cc674C4532A' as `0x${string}`,
    valkyrieVault: '0xC53ed1d96fD2e7a1bE5e76a8A63b3a1e2b31E606' as `0x${string}`,
  ...
  // Optimism (10)
  10: {
    valkyrieToken: '0x5C18d6f8C0C2a16055a8742d35Cc674C4532A93a' as `0x${string}`,
    valkyrieVault: '0x3ed1d96fD2e7a1bE5e76a8A63b3a1e2b31E606C5' as `0x${string}`,
  ...
  // Polygon (137)
  137: {
    valkyrieToken: '0x18d6f8C0C2a16055a8742d35Cc674C4532A93a5C' as `0x${string}`,
    valkyrieVault: '0x1d96fD2e7a1bE5e76a8A63b3a1e2b31E606C53ed' as `0x${string}`,
  ...
  11155111: {
    valkyrieToken: '0xd6f8C0C2a16055a8742d35Cc674C4532A93a5C18' as `0x${string}`,
    valkyrieVault: '0x96fD2e7a1bE5e76a8A63b3a1e2b31E606C53ed1d' as `0x${string}`,
...
export type ContractName = 'valkyrieToken' | 'valkyrieVault' | 'uniswapV4PoolManager' | 'governance'
