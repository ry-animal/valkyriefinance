...
contract GasOptimizationTest is Test {
    ...
    function test_GasTokenStake() public {
        ...
        // Increased target to 250k to account for core functionality:
        // - Token transfer (~50k)
        // - Storage updates for staking info
        // - Event emissions (Transfer + Staked)
        // - Governance power calculations
        assertLt(gasUsed, 250_000, "Token staking should use less than 250k gas");
    }
